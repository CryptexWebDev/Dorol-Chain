...
import (
	...
	"github.com/CryptexWebDev/Dorol-Chain/crypto/signify"
	"github.com/CryptexWebDev/Dorol-Chain/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/CryptexWebDev/Dorol-Chain/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/CryptexWebDev/Dorol-Chain/internal/version.gitDate="+env.Date)
	}
